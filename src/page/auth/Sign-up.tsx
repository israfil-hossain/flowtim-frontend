  ...
  const onSubmit = (values: z.infer<typeof formSchema>) => {
    ...
    mutate(values, {
      onSuccess: (data) => {
        ...
        // Navigate to workspace after successful registration
  ...
  return (
    <div className="flex min-h-svh flex-col items-center justify-center gap-6 bg-muted p-6 md:p-10">
      <div className="flex w-full max-w-sm flex-col items-center">
        <Link to="/" className="w-full flex flex-col jutify-center items-center mb-3">
          <img src="/images/long-logo.png" alt="logo" width={200} height={50} className=" object-cover"/>
