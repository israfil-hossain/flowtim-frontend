...
const InviteUser = () => {
  ...
  const returnUrl = encodeURIComponent(
    `${BASE_ROUTE.INVITE.replace(":token", inviteCode)}`
  );
  ...
  const handleSubmit = (e: { preventDefault: () => void }) => {
    ...
    mutate(inviteCode, {
      onSuccess: (data) => {
        ...
        trackWorkspaceJoined(data.workspaceId);
          ...
          <Card>
            <CardHeader className="text-center">
              <CardTitle className="text-xl">
                Hey there! You're invited to join a Flowtim Workspace!
              </CardTitle>
              <CardDescription>
                Looks like you need to be logged into your Flowtim account to
                join this Workspace.
              </CardDescription>
            </CardHeader>
            <CardContent>
