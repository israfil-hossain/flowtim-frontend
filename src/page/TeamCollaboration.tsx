...
const FEATURES = [
  {
    ...
    description: "Instant messaging and threaded conversations for seamless team communication",
    details: [
  ...
  },
  {
    ...
    description: "Organize teams, assign roles, and manage permissions effectively",
    details: [
...
const COLLABORATION_BENEFITS = [
  {
    ...
    description: "Real-time communication reduces delays and accelerates project decisions",
    metric: "40% faster"
  },
  {
    icon: Heart,
    title: "Better Team Engagement",
    description: "Collaborative tools increase team satisfaction and participation",
    metric: "85% satisfaction"
  },
  {
    icon: Users,
    title: "Improved Coordination",
    description: "Centralized communication prevents miscommunication and duplicated work",
        ...
        <Wrapper>
          <div className="text-center max-w-4xl mx-auto">
            <AnimationContainer animation="fadeUp" delay={0.1}>
              <SectionBadge title="Team & Collaboration" />
            </AnimationContainer>
            ...
            <AnimationContainer animation="fadeUp" delay={0.3}>
              <p className="text-xl text-muted-foreground max-w-2xl mx-auto font-uncut leading-relaxed">
                Break down communication barriers and foster seamless collaboration with 
                integrated tools designed for modern distributed teams.
              </p>
            </AnimationContainer>
          ...
          <div className="text-center mb-16">
            ...
            <AnimationContainer animation="fadeUp" delay={0.2}>
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto font-uncut">
                Everything your team needs to communicate, collaborate, and create together.
              </p>
            </AnimationContainer>
          </div>
      ...
      <section className="py-20 lg:py-32 bg-muted/20">
        <Wrapper>
          <div className="text-center mb-16">
            ...
            <AnimationContainer animation="fadeUp" delay={0.2}>
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto font-uncut">
                Experience how our integrated collaboration tools bring teams together.
              </p>
            </AnimationContainer>
          </div>
              ...
              <div className="relative rounded-2xl border border-border bg-background/50 backdrop-blur-sm p-4 shadow-2xl">
                ...
                <div className="absolute top-6 right-6 bg-background/90 backdrop-blur-sm border border-border rounded-lg p-3 shadow-lg">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs font-medium">3 active collaborators</span>
                  </div>
                </div>
      ...
      <section className="py-20 lg:py-32">
        <Wrapper>
          <div className="text-center mb-16">
            ...
            <AnimationContainer animation="fadeUp" delay={0.2}>
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto font-uncut">
                See the measurable impact of effective collaboration on your team's success.
              </p>
            </AnimationContainer>
          </div>
      ...
      <section className="py-20 lg:py-32 bg-muted/20">
        <Wrapper>
          <div className="text-center mb-16">
            ...
            <AnimationContainer animation="fadeUp" delay={0.2}>
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto font-uncut">
                Connect with your favorite tools and maintain your existing workflow.
              </p>
            </AnimationContainer>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
            {INTEGRATION_FEATURES.map((integration, index) => (
              <AnimationContainer key={index} animation="fadeUp" delay={0.3 + (index * 0.05)}>
            ...
            <div>
              ...
              <AnimationContainer animation="fadeUp" delay={0.2}>
                <p className="text-lg text-muted-foreground font-uncut mb-8">
                  Whether you're a small startup or a large enterprise, Flowtim scales with your team's collaboration needs.
                </p>
              </AnimationContainer>
              ...
              <div className="space-y-6">
                <AnimationContainer animation="fadeUp" delay={0.3}>
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="font-medium font-nohemi mb-1">Small Teams (2-10)</h3>
                      <p className="text-sm text-muted-foreground font-uncut">Perfect for startups and small projects with essential collaboration features.</p>
                    </div>
                  </div>
                </AnimationContainer>
                ...
                <AnimationContainer animation="fadeUp" delay={0.4}>
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="font-medium font-nohemi mb-1">Medium Teams (10-100)</h3>
                      <p className="text-sm text-muted-foreground font-uncut">Advanced features for growing teams with complex project requirements.</p>
                    </div>
                  </div>
                </AnimationContainer>
                ...
                <AnimationContainer animation="fadeUp" delay={0.5}>
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="font-medium font-nohemi mb-1">Enterprise (100+)</h3>
                      <p className="text-sm text-muted-foreground font-uncut">Enterprise-grade security and administration for large organizations.</p>
                    </div>
                  </div>
                </AnimationContainer>
              </div>
            ...
            <div className="grid grid-cols-2 gap-6">
              <AnimationContainer animation="fadeUp" delay={0.3}>
                <div className="bg-gradient-to-br from-primary/10 to-accent/10 p-6 rounded-2xl text-center">
                  <div className="text-3xl font-bold font-nohemi text-primary mb-2">11k+</div>
                  <div className="text-sm text-muted-foreground font-uncut">Active Teams</div>
                </div>
              </AnimationContainer>
              <AnimationContainer animation="fadeUp" delay={0.4}>
                <div className="bg-gradient-to-br from-accent/10 to-secondary/10 p-6 rounded-2xl text-center">
                  <div className="text-3xl font-bold font-nohemi text-primary mb-2">500k+</div>
                  <div className="text-sm text-muted-foreground font-uncut">Messages Sent</div>
                </div>
              </AnimationContainer>
              <AnimationContainer animation="fadeUp" delay={0.5}>
                <div className="bg-gradient-to-br from-secondary/10 to-primary/10 p-6 rounded-2xl text-center">
                  <div className="text-3xl font-bold font-nohemi text-primary mb-2">99.9%</div>
                  <div className="text-sm text-muted-foreground font-uncut">Uptime</div>
                </div>
              </AnimationContainer>
              <AnimationContainer animation="fadeUp" delay={0.6}>
                <div className="bg-gradient-to-br from-primary/10 to-secondary/10 p-6 rounded-2xl text-center">
                  <div className="text-3xl font-bold font-nohemi text-primary mb-2">24/7</div>
                  <div className="text-sm text-muted-foreground font-uncut">Support</div>
                </div>
              </AnimationContainer>
            </div>
          </div>
          ...
          <div className="text-center">
            ...
            <AnimationContainer animation="fadeUp" delay={0.2}>
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto font-uncut mb-8">
                Join thousands of teams who have revolutionized their collaboration with Flowtim.
              </p>
            </AnimationContainer>
            <AnimationContainer animation="fadeUp" delay={0.3}>
